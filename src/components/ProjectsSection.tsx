...
const projects = [
  ...
  },
  {
    ...
    description: "Created an intuitive, easy-to-navigate e-commerce website for a personalised guitar brand — making product discovery and purchasing effortless for customers. The design focuses on showcasing the unique features of the guitars while providing a seamless shopping experience.",
    role: "UX/UI Designer",
    deliverables: ["Information Architecture", "UI Design", "E-commerce UX"],
